...
class SeasonController extends AbstractController
{
    ...
    public function new(Request $request, SeasonRepository $seasonRepository, MailerInterface $mailer): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $email = (new Email())
                ...
                ->html($this->renderView('Email/newSeasonEmail.html.twig', ['season' => $season]));

            $mailer->send($email);

            $this->addFlash('success', 'Your season has been added');
    ...
    {
        $this->addFlash('danger', 'Your season has been deleted');
